...
exports.bookinstance_update_get = asyncHandler(async (req, res, next) => {
  // Get book, bookinstance and all books for form.
...
exports.bookinstance_update_post = [
  //convett bookinstance to an array
  (req, res, next) => {
    if (!Array.isArray(req.body.bookinstance)) {
      req.body.bookinstance === "undefined" ? [] : [req.body.bookinstance];
    }
    next();
  },
  ...
  asyncHandler(async (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      // There are errors. Remnder form again with sanitized values/error messages.
